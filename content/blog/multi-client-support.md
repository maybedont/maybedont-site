...
We’re excited to introduce a major milestone: **multi-client support for connecting to multiple MCP servers in parallel**. This key feature (an essential piece of a gateway) is designed to help organizations scale their use of the Model Context Protocol (MCP) securely and efficiently.
